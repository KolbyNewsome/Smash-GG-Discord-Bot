...
class GigiCog(commands.Cog):
    ...
    async def stopqueue(self, ctx):
        '''
        Stops the auto_queue task that watches for players in the stream queue. ADMIN ONLY.
        '''
        self.auto_queue.cancel()
    ...
    async def startqueue(self, ctx):
        '''
        Restarts the auto_queue task that watches for players in the stream queue. ADMIN ONLY.
        '''
        self.auto_queue.start()
